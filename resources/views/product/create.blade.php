...
<div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__body">
                ...
                {!! Form::open(['route'=>['product.store'],'method'=>'POST','class'=>'form-horizontal form-label-left ','novalidate','files'=>true]) !!}
                ...
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    {{-- <ul id="myTab" class="nav nav-tabs bar_tabs right" role="tablist">
                        @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                            ...
                            <li role="presentation" class="{{$loop->iteration === 2 ? 'active' : '' }}"><a href="#{{ $properties['native'] }}" role="tab" id="profile-tab"
                                                                data-toggle="tab" aria-expanded="true">{{trans('backend.'.$properties['name'])}}</a>
                            </li>
                        @endforeach
                    ...
                    <div class="row form-group">
                        <label class="col-form-label col-sm-12 col-md-2" for="">{{trans('backend.price')}} 
                        </label>
                        <div class="col-sm-12 col-md-10">
                            <input type="number" id="first-name" name="price" required class="form-control" value="{{old('price')}}" placeholder="{{trans('backend.price')}} ">
                    ...
                    <div class="form-group">
                        <div class="myBtn">
                            ...
                            <a href="{{route('product.index')}}"  class="btn btn-primary btn-square">{{trans('backend.back')}}</a>
