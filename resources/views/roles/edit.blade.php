                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="row form-group">
                            ...
                            {!! Form::text('name', null, array('placeholder' => 'Name','class' => 'form-control col-sm-12 col-md-10')) !!}
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                        <div class="myBtn">
                                <button type="submit" class="btn btn-primary btn-square">{{trans('backend.update')}}</button>
                        </div>
                    </div>
                </div>
                {!! Form::close() !!}
...
{{-- 
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
            <button type="submit" class="btn btn-primary">{{trans('backend.update')}}</button>
        </div>
    </div>
    {!! Form::close() !!} --}}
