        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
                <div class="kt-portlet__head-label">
                    ...
                    <h3 class="kt-portlet__head-title">
                            {{trans('backend.category_product_update')}}
                    </h3>
                </div>
            </div>
            ...
            <div class="kt-portlet__body">
                ...
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    ...
                    <div class="row form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="first-name" maxlength="25" name="name[{{$localeCode}}]" required class="form-control" value="{{unserialize($data->name)[$localeCode]}}" placeholder="{{trans('backend.name_'.$properties['name'])}}">
                            </div>
                        </div>
                    @endforeach
