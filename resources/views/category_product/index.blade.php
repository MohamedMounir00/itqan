        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
                <div class="kt-portlet__head-label">
                    ...
                    <h3 class="kt-portlet__head-title">
                            {{trans('backend.categoriesOfProduct')}}
                    </h3>
                </div>
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        ...
                        <div class="kt-portlet__head-actions">
                            <a href="{{route('category_product.create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
...
{{-- 
    ...
    <div class="x_panel">
            <div class="x_title">
                <h2>{{trans('backend.categoriesOfProduct')}}</h2>
    ...
    <script>
        $(function() {
            $('#table1').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('category_product.get_category') !!}',
                columns: [
                    { data: 'name', name: 'name' },
