        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
                <div class="kt-portlet__head-label">
                    ...
                    <h3 class="kt-portlet__head-title">
                            {{trans('backend.category_product_create')}}
                    </h3>
                </div>
            </div>
            ...
            <div class="kt-portlet__body">
                ...
                {!! Form::open(['route'=>['category_product.store'],'method'=>'POST','class'=>'form-horizontal form-label-left ','novalidate','files'=>true]) !!}
                ...
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    ...
                    <div class="form-group">
                        <div class="myBtn">
                            ...
                            <a href="{{route('category_product.index')}}"  class="btn btn-primary btn-square">{{trans('backend.back')}}</a>
