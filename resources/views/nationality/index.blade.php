                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            ...
                            <div class="kt-portlet__head-actions">
                                <a href="{{route('nationality.create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
                                                    ...
                                                    <table id="table2" class="table table-striped table-bordered bulk_action table1">
                                                        ...
                                                        @foreach($nationality as $national)
                                                               <tr id="{{$national->id}}">
                                                                ...
                                                                <td>
                                                                    <a href="{{ route('nationality.edit', $national->id)}}" class="btn btn-square  btn-primary"> {{trans('backend.update')}}</a>
                                                                    <button class="btn btn-delete btn btn-square  btn-danger" data-remote="{{$national->id }}" data-id="{{ $national->id }}"><i class="fa fa-remove"></i>{{trans('backend.delete')}}</button>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                        </tbody>
