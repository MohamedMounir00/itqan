...
<div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__body">
                    {!! Form::open(['route'=>['currency.store'],'method'=>'POST','class'=>'form-horizontal form-label-left ','novalidate','files'=>true]) !!}
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        ...
                        <div class="row form-group">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input type="text" id="first-name" name="name[{{$localeCode}}]" required class="form-control" placeholder="{{trans('backend.name_'.$properties['name'])}}">
                                </div>
                            </div>
                        @endforeach
