                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        ...
                        <div class="kt-portlet__head-actions">
                            <a href="{{route('currency.create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
    ...
    <div class="x_panel">
            <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                    ...
                    <li><a   href="{{route('currency.create')}}" class=""><i class="fa fa-plus-square"></i></a>
                    </li>
                        @endcan
                </ul>
    ...
    <script>
        $(function() {
            $('#table1').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('currency.get_currency') !!}',
                columns: [
                    { data: 'name', name: 'name' },
