        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
                <div class="kt-portlet__head-label">
                    ...
                    <h3 class="kt-portlet__head-title">
                            {{trans('backend.ministries_create')}}
                    </h3>
                </div>
            </div>
            ...
            <div class="kt-portlet__body">
                ...
                {!! Form::open(['route'=>['ministries.store'],'method'=>'POST','class'=>'form-horizontal form-label-left ','novalidate','files'=>true]) !!}
                            ...
                            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                ...
                                <div class="row form-group">
                                        ...
                                        <div class="col-sm-12 col-md-10">
                                            <input type="text" id="first-name" maxlength="25" name="name[{{$localeCode}}]" required class="form-control" placeholder="{{trans('backend.name_'.$properties['name'])}} ">
                                        </div>
                                    </div>
                                @endforeach
                                ...
                                <div class="form-group">
                                    <div class="myBtn">
                                        ...
                                        <a href="{{route('ministries.index')}}"  class="btn btn-primary btn-square">{{trans('backend.back')}}</a>
...
{{-- 
            <div class="clearfix"></div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h3>{{trans('backend.ministries_create')}}</h3>
