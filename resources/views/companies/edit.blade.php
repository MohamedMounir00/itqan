...
<div class="kt-portlet kt-portlet--mobile">
    <div class="kt-portlet__head kt-portlet__head--lg">
        <div class="kt-portlet__head-label">
            ...
            <h3 class="kt-portlet__head-title">
                    {{trans('backend.companies_update')}}
            </h3>
        </div>
    </div>
    ...
    <div class="kt-portlet__body">
        ...
        {!! Form::open(['route'=>['companies.update',$data->id],'method'=>'PUT','class'=>'form-horizontal form-label-left ','novalidate','files'=>true]) !!}
                            ...
                            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                ...
                                <div class="row form-group">
                                        ...
                                        <div class="col-sm-12 col-md-10">
                                            <input type="text" id="first-name" maxlength="25" name="name[{{$localeCode}}]" required class="form-control" value="{{unserialize($data->name)[$localeCode]}}">
                                        </div>
                                    </div>
                                @endforeach
                            ...
                            <div class="form-group">
                                <div class="myBtn">
                                    ...
                                    <a href="{{route('companies.index')}}"  class="btn btn-primary btn-square">{{trans('backend.back')}}</a>
...
{{-- 
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h3>{{trans('backend.companies_update')}}</h3>
