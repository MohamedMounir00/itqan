...
public  static function  assignDynamic($order)
{
    ...
    $name = [
        ...
        'en' => $technical->name . ' ' . ' assign technical ' . trans('api.repairing', [], 'en') . unserialize($order->category->main->name)['en'],
    ];
    ...
    public  static function  assignDynamicForRescheduleds($order, $assign_status = "agree")
    {
